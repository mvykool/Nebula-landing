...
import featuresdiagonal from "../assets/images/demo.png";
      ...
      >
        <div className=" 2xl:w-[1150px] xl:w-[1050px]  md:w-4/5 flex justify-center bg-bgDark1 pt-12 lg:pt-24 pb-8 lg:pb-20 mx-auto lg:flex-row flex-col">
          <div className="w-3/4 lg:w-1/2 flex flex-col lg:mx-unset mx-auto">
            <span className="block-subtitle">Build, iterate, and publish</span>
            <h2 className="mt-10 mb-8 text-4xl lg:text-5xl block-big-title">
              Turn your ideas and thoughts into shareable projects
            </h2>
            <p className="mb-16 text-secondaryText leading-loose">
              Our platform enables you to launch your projects with ease.
          ...
          <div className="w-4/5 lg:w-1/2 lg:pl-16 flex justify-center mx-auto pt-16 lg:pt-0">
            <img
              ...
              alt="Feature image"
              className="rounded-xl object-cover object-left  main-border-gray"
            />
          </div>
        </div>
      </motion.div>
